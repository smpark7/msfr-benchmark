...
\begin{table}[htbp!]
	\caption{Delayed neutron source along centerlines $AA'$ and $BB'$.}
	\centering
	\footnotesize
	\setlength\tabcolsep{1.5pt}
	\begin{tabular}{c c c c c c c c c c c}
		...
		& & {(0,1)} & {(0.25,1)} & {(0.5,1)} & {(0.75,1)} & {(1,1)} & {(1.25,1)} & {(1.5,1)} & {(1.75,1)} & {(2,1)} \\
		\midrule
		\multirow{7}{*}{\shortstack[1]{$\sum_i \lambda_i C_i$\\(m$^{-3}$s$^{-1}$)}} & Moltres & 1.559E+16 & 1.431E+17 & 2.201E+17 & 2.411E+17 & 2.272E+17 & 1.932E+17 & 1.473E+17 & 9.415E+16 & 1.605E+16 \\
		...
		& & {(1,0)} & {(1,0.25)} & {(1,0.5)} & {(1,0.75)} & {(1,1)} & {(1,1.25)} & {(1,1.5)} & {(1,1.75)} & {(1,2)} \\
		\midrule
		\multirow{7}{*}{\shortstack[1]{$\sum_i \lambda_i C_i$\\(m$^{-3}$s$^{-1}$)}} & Moltres & 1.528E+16 & 1.182E+17 & 1.875E+17 & 2.192E+17 & 2.272E+17 & 2.268E+17 & 2.188E+17 & 1.775E+17 & 3.633E+16 \\
...
\section*{Step 1.2: Power Coupling}
